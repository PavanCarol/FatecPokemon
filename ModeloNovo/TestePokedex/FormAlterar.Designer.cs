namespace TestePokedex
{
    partial class FormAlterar
    {
        ...
        private void InitializeComponent()
        {
            ...
            label6.Font = new Font("Comic Sans MS", 20F, FontStyle.Bold, GraphicsUnit.Point);
            label6.Location = new Point(101, 432);
            label6.Margin = new Padding(4, 0, 4, 0);
            label6.Name = "label6";
            label6.Size = new Size(208, 55);
            label6.TabIndex = 11;
            label6.Text = "Bulbasaur";
            // 
            // panel1
            // 
            ...
            label1.Location = new Point(395, 161);
            ...
            ClientSize = new Size(994, 596);
            Controls.Add(panel1);
            Controls.Add(label6);
            Controls.Add(pictureBox1);
            Name = "FormAlterar";
            Text = "FormAlterar";
            Load += FormAlterar_Load;
